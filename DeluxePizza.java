...
public class DeluxePizza extends PizzaApp {
	
	String base; // round, square
	String size; // small, medium, large, x-large
	
	double BASE_PRICE = 9.99;
	...
	public void totalPizzaPrice() {
		...
		System.out.println("Total Price for your Deluxe Pizza ==> $" + totalCost + " + 13% Tax = " + (double) Math.round(priceAfterTax * 100)/100);
	}
